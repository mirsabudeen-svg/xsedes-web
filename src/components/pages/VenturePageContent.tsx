 ...
 * Back link returns to /brands directory.
 */
  ...
  return (
    <main>
      <Link
        ...
        className="fixed left-5 top-5 z-10 border border-[var(--hairline-strong)] bg-black/60 px-3.5 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--faint)] no-underline backdrop-blur-[6px] transition-colors duration-300 ease-[var(--ease)] hover:border-[var(--accent)] hover:text-[var(--accent)] focus-visible:border-[var(--accent)] focus-visible:text-[var(--accent)] focus-visible:outline-none"
      >
      ...
      <section
        ref={sectionRef}
        id={sectionId}
        className="relative flex min-h-screen flex-col items-center justify-center gap-6 border-b border-[var(--hairline)] px-[clamp(28px,7vw,110px)] py-[120px] text-center"
      >
        <CornerMarks />
        <Reveal wipe>
